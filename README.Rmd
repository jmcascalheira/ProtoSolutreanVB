...
You can download the compendium as a zip from from this URL: <https://github.com/jmcascalheira/ProtoSolutreanVB/archive/master.zip>

Or you can install this compendium as an R package, ProtoSolutreanVB, from GitHub with:
